...
const ContactState = props => {
	const initialState = {
		contacts:[{id:1,name:'Pat Moore',email:'patisawesome@gmail.com',phone:'111-111-1111',type:'Personal'},
		{id:2,name:'Anna Rogers',email:'annroger@gmail.com',phone:'111-111-1111',type:'Professional'}],
		current:null,
		filter:null
	};
